...
unsigned long baudrate =
    19200;  // Must match what you configure on the ODrive (see docs for details)
...
// See https://www.arduino.cc/reference/en/language/functions/communication/serial/ for other
// options HardwareSerial& odrive_serial = Serial1; int baudrate = 115200; // Must match what you
// configure on the ODrive (see docs for details)
...
void loop() {
    ...
    odrive.setPosition(sin(phase) * 15,                     // position
                       cos(phase) * (TWO_PI / SINE_PERIOD) * 15  // velocity feedforward (optional)
    );
