...
bytestoSend = 0b00000000_00000000_00000000_00110000_00000000_00000000_00000001.to_bytes(7, "big")
# s.send(bytestoSend)
...
# init pin 2 as output
#               subdevice id,       action code,       checksum,       payload
bytestoSend = 0b00000000_00000000_00000000_00010000_00000000_00000000_01000001001000000000000000000000.to_bytes(
    10, "big"
)
# s.send(bytestoSend)
s.sendto(bytestoSend, ("192.168.2.25", 57344))
